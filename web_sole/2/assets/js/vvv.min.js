    ...
    if (e.keyCode == 9) {
      ...
      switch (cmd) {
        case 'ls':
          ...
          break;
        case 'socials':
              output("choose a number <br><br>[1] instagram <br>[2] twitter <br>[3] tryhackme <br> [4] imgur");
        break;     
          case '1':
          window.open("https://instagram.com/wxrn.z", "_blank");                    
          break;
          case '2':
          window.open("https://twitter.com/w4here", "_blank");                    
          break;
          case '3':
          window.open("https://tryhackme.com/p/networkysh", "_blank");                    
          break;
          case '4':
          window.open("https://imgur.com/a/6lAZ6Vm", "_blank");
        case 'play':
